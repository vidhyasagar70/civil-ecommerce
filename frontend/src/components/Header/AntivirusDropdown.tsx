        ...
        products: [
            {
                ...
                topProducts: [
                    ...
                    { name: "K7 Internet Security", href: "/antivirus/k7-internet-security" },
                    { name: "K7 Ultimate Security", href: "/antivirus/k7-ultimate-security" },
                    { name: "K7 Antivirus Premium", href: "/antivirus/k7-antivirus-premium" },
                ],
            },
            {
                name: "Quick Heal",
                ...
                topProducts: [
                    { name: "Quick Heal Total Security", href: "/antivirus/quick-heal-total-security" },
                    { name: "Quick Heal Internet Security", href: "/antivirus/quick-heal-internet-security" },
                    { name: "Quick Heal Antivirus Pro", href: "/antivirus/quick-heal-antivirus-pro" },
                ],
            },
            {
                name: "Norton",
                ...
                topProducts: [
                    ...
                    { name: "Norton 360 Standard", href: "/antivirus/norton-360-standard" },
                    { name: "Norton AntiVirus Plus", href: "/antivirus/norton-antivirus-plus" },
        ...
        products: [
            {
                ...
                topProducts: [
                    { name: "McAfee Total Protection", href: "/antivirus/mcafee-total-protection" },
                    { name: "McAfee LiveSafe", href: "/antivirus/mcafee-livesafe" },
                    { name: "McAfee AntiVirus Plus", href: "/antivirus/mcafee-antivirus-plus" },
                    { name: "McAfee Small Business Security", href: "/antivirus/mcafee-business" },
                ],
            },
            {
                name: "ESET",
                ...
                topProducts: [
                    ...
                    { name: "ESET Internet Security", href: "/antivirus/eset-internet-security" },
                    { name: "ESET Smart Security Premium", href: "/antivirus/eset-smart-security" },
        ...
        products: [
            {
                ...
                topProducts: [
                    { name: "Hyper Say Total Security", href: "/antivirus/hyper-say-total-security" },
                    { name: "Hyper Say Internet Security", href: "/antivirus/hyper-say-internet-security" },
                    { name: "Hyper Say Antivirus", href: "/antivirus/hyper-say-antivirus" },
                ],
            },
        ],
    },
...
const AntivirusDropdown: React.FC<AntivirusDropdownProps> = ({
    ...
    return (
        ...
        >
            ...
            >
                <h3 className="text-xl font-bold mb-1" style={{ color: colors.text.primary }}>
            ...
            {/* Categories Grid */}
            <div className="grid grid-cols-3 gap-0" style={{ backgroundColor: colors.background.primary }}>
                            ...
                            {category.products.map((product) => (
                                <li key={product.name} className="group">
                                    <button
                                        ...
                                        style={{
                                            backgroundColor: hoveredProduct === product.name ? colors.background.accent : 'transparent',
                                        }}
                                    >
                                        <span
                                            className="font-medium text-sm transition-colors"
                                            style={{
                                                color: hoveredProduct === product.name ? colors.interactive.primary : colors.text.primary
                                            }}
                                        >
                                            {product.name}
                                        </span>
                                        {product.topProducts && (
                                            <ChevronRight
                                                ...
                                                style={{
                                                    color: hoveredProduct === product.name ? colors.interactive.primary : colors.text.secondary
                                                }}
                                            />
                                        )}
                                    </button>
                                    ...
                                    {product.topProducts && hoveredProduct === product.name && (
                                        <ul className="ml-4 mt-1 space-y-0.5 pl-3 border-l-2" style={{ borderColor: colors.interactive.primary }}>
