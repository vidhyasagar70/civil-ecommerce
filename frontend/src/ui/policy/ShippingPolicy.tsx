  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Intro */}
        <p
          className="text-lg text-gray-700 mb-6 leading-relaxed transition-colors duration-200"
        ...
        <p
          className="text-gray-700 mb-6 leading-relaxed transition-colors duration-200"
          style={{ color: colors.text.secondary }}
        >
        ...
        {/* Shipping Options */}
        <h2
          className="text-2xl font-semibold text-gray-900 mt-10 mb-4 transition-colors duration-200"
          style={{ color: colors.text.secondary }}
        >
          What Are My Shipping & Delivery Options?
        </h2>
        <p
          className="text-gray-700 mb-4 leading-relaxed transition-colors duration-200"
          style={{ color: colors.text.secondary }}
        >
        ...
        <ul
          className="list-disc pl-6 space-y-2 text-gray-700 transition-colors duration-200"
          style={{ color: colors.text.secondary }}
        >
