    ...
    return (
        ...
        >
            ...
            >
                ...
                <p className=" mb-4 leading-relaxed transition-colors duration-200" style={{ color: colors.text.secondary }}>
                ...
                <ul className="list-disc pl-6 space-y-2  transition-colors duration-200" style={{ color: colors.text.secondary }}>
                    <li>📧 Email: civildigitalstore@gmail.com</li>
                    <li>📞 Phone: 8807423228</li>
                </ul>
                <p className=" mb-6 leading-relaxed transition-colors duration-200" style={{ color: colors.text.secondary }}>
                ...
                <p className=" mb-4 leading-relaxed transition-colors duration-200" style={{ color: colors.text.secondary }}>To be eligible for a return:</p>
                <ul className="list-disc pl-6 space-y-2  transition-colors duration-200" style={{ color: colors.text.secondary }}>
                ...
                <p className=" mb-4 leading-relaxed transition-colors duration-200" style={{ color: colors.text.secondary }}>Questions about this policy?</p>
                <ul className="list-disc pl-6 space-y-2  transition-colors duration-200" style={{ color: colors.text.secondary }}>
                    <li>📧 Email: civildigitalstore@gmail.com</li>
                    <li>📞 Phone: 8807423228</li>
                </ul>
