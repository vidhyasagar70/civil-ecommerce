...
import { getAllReviews, deleteReview, updateReview, type Review } from '../../api/reviewApi';
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center py-12">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2" style={{ borderColor: colors.interactive.primary }}></div>
                <span className="ml-2" style={{ color: colors.text.secondary }}>Loading reviews...</span>
            </div>
        );
    }
        ...
        <div className="space-y-6">
            ...
            {editingReview && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    ...
                    >
                        <h3 className="text-lg font-bold mb-4" style={{ color: colors.text.primary }}>Edit Review</h3>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        ...
                        >
                            {reviews.length === 0 ? (
                                <tr>
                                    <td colSpan={6} className="px-4 py-8 text-center" style={{ color: colors.text.secondary }}>
                                        No reviews found
                                    </td>
                                </tr>
                            ) : (
