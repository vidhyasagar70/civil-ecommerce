    ...
    <div className="p-4 sm:p-6 min-h-screen bg-admin-bg-primary">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-2 sm:p-6 gap-3">
        <div className="flex flex-col gap-1 w-full sm:w-auto">
          ...
          <p className="mt-1 text-sm sm:text-base text-admin-text-secondary" style={{ color: colors.text.secondary }}>Create & manage promotional banners</p>
        </div>
      ...
      <div className="mt-4 sm:mt-6 flex flex-col gap-4">
        {loading ? <div className="text-center py-16 text-admin-text-secondary">Loading...</div> :
          banners.length === 0 ? <div className="text-center py-16 border-2 border-dashed rounded-lg border-admin-border-primary">
